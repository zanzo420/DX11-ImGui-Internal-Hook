...
{
public:
	uint8                                        Pad_1F34[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F3E[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F3F[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FCodexEntryArraySerializer            GrantedCodices;                                    // 0x100(0x188)(Net, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1F40[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1F41[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
