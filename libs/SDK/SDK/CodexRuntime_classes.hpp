...
{
public:
	uint8                                        Pad_2176[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_217F[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2184[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FCodexEntryArraySerializer            GrantedCodices;                                    // 0x100(0x188)(Net, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2185[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2186[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
