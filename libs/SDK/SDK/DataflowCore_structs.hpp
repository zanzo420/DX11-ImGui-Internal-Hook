...
{
public:
	uint8                                        Pad_A22[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_A23[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
