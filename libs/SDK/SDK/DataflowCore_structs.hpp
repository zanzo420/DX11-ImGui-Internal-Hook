...
{
public:
	uint8                                        Pad_10F8[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1103[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
