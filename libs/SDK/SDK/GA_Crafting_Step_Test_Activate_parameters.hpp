...
public:
	...
	uint8                                        Pad_7893[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7895[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_Step_Test                 CallFunc_GetStructByType_OutStruct;                // 0xD8(0x11)(HasGetValueTypeHash)
	uint8                                        Pad_7896[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
