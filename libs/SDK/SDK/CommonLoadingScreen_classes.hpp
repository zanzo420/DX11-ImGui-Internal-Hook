...
{
public:
	uint8                                        Pad_2C39[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C3A[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C56[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
