...
public:
	...
	uint8                                        Pad_2FDC[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2FDE[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2FE2[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2FE3[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
