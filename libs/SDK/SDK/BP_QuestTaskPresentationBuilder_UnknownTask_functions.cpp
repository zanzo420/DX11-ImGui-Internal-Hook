...
class UClass* UBP_QuestTaskPresentationBuilder_UnknownTask_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_QuestTaskPresentationBuilder_UnknownTask_C");

	return Clss;
}


// BP_QuestTaskPresentationBuilder_UnknownTask_C BP_QuestTaskPresentationBuilder_UnknownTask.Default__BP_QuestTaskPresentationBuilder_UnknownTask_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_QuestTaskPresentationBuilder_UnknownTask_C* UBP_QuestTaskPresentationBuilder_UnknownTask_C::GetDefaultObj()
{
	static class UBP_QuestTaskPresentationBuilder_UnknownTask_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_QuestTaskPresentationBuilder_UnknownTask_C*>(UBP_QuestTaskPresentationBuilder_UnknownTask_C::StaticClass()->DefaultObject);
