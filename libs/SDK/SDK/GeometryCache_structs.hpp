...
{
public:
	uint8                                        Pad_882[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_883[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_884[0x9];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_885[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
