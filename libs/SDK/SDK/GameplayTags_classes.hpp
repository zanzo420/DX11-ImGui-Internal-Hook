...
public:
	...
	uint8                                        Pad_19F3[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19F4[0x160];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_19F5[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
