...
{
public:
	uint8                                        Pad_88[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_8E[0x6];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_91[0x50];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9C[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
