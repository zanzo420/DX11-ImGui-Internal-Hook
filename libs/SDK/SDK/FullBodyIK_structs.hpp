...
public:
	...
	uint8                                        Pad_4B9A[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4B9B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4B9E[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4B9F[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4BA1[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4BA2[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
