...
public:
	...
	uint8                                        Pad_1F0A[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1F0C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F0F[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
