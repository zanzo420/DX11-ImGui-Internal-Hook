...
public:
	...
	uint8                                        Pad_A29F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTag                          Temp_struct_Variable;                              // 0x24(0x8)(ConstParm, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A2A1[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A2A5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A2AB[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
