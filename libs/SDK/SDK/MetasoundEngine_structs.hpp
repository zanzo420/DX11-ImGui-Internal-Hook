...
{
public:
	uint8                                        Pad_4A27[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4A28[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4A29[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
