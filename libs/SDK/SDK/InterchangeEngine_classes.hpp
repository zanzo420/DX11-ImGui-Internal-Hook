...
{
public:
	uint8                                        Pad_4862[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4868[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4876[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4877[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
