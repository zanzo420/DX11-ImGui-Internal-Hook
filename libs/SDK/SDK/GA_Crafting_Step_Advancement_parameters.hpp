...
public:
	...
	uint8                                        Pad_A52[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCraftForID_CraftInProgressData;        // 0x200(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_A54[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A75[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	bool                                         ReturnValue;                                       // 0x0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A89[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
