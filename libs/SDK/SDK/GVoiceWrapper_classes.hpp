...
public:
	...
	uint8                                        Pad_32CD[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_32D0[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_32D2[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FString, class FString>           PlayerUniqueIdToNameMap;                           // 0x160(0x50)(Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_32D3[0x170];                                   // Fixing Size Of Struct [ Dumper-7 ]
