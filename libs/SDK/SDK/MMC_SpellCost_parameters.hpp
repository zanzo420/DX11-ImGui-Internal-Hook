...
struct UMMC_SpellCost_C_BaseCost_Params
{
public:
	...
	uint8                                        Pad_A873[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute_1; // 0x308(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A874[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_GetFloatAttribute_ReturnValue_1;          // 0x30C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAttribute                    Temp_struct_Variable;                              // 0x318(0x38)(ConstParm, HasGetValueTypeHash)
	...
	double                                       K2Node_MakeArray__2__ImplicitCast;                 // 0x370(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UMMC_SpellCost_C_NWXCalculateBaseMagnitude_Params
{
public:
	...
	uint8                                        Pad_A877[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
