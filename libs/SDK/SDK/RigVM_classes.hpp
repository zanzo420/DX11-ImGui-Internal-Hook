...
{
public:
	uint8                                        Pad_3C9C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3CBB[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3CBD[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FName>                          FunctionNamesStorage;                              // 0x120(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3CBE[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3CBF[0x98];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3CC0[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3CC4[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3CC9[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3CCC[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3D38[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3D39[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FName>                          EventQueue;                                        // 0x248(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_3D3A[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3D3B[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
