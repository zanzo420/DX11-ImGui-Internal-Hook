...
{
public:
	uint8                                        Pad_12FF[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1300[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1302[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
