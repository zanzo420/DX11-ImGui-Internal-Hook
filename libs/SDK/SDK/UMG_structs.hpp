...
{
public:
	uint8                                        Pad_1450[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1459[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1484[0x590];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1488[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
