...
{
public:
	uint8                                        Pad_26B0[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_26DF[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_26E1[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UChallengeDataAsset*>           PendingAdds;                                       // 0x178(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_26E2[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_26E4[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
