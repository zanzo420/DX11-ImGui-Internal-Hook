...
{
public:
	uint8                                        Pad_2BBE[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BD3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BE2[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BE4[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UChallengeDataAsset*>           PendingAdds;                                       // 0x178(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2BE6[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BEC[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
