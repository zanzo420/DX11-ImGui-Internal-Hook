...
public:
	...
	uint8                                        Pad_3CF7[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3CF8[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3D06[0x13];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3D0C[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
