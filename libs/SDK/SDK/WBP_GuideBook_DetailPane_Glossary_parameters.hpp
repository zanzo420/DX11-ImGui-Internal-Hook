...
public:
	...
	uint8                                        Pad_8C52[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8C54[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UWBP_GuideBook_Thumb_C*                K2Node_DynamicCast_AsWBP_Guide_Book_Thumb;         // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8C55[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_1;            // 0x24(0x10)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_8C56[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FResourceLevelRange                   CallFunc_GetLevelRange_ReturnValue;                // 0xC(0x8)(ConstParm, NoDestructor)
	uint8                                        Pad_8C57[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
