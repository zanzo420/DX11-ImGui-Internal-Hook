...
public:
	...
	uint8                                        Pad_465B[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4661[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	class APlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4662[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
