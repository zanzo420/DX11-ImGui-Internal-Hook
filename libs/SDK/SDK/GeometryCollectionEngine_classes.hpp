...
public:
	...
	uint8                                        Pad_A81[0x168];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BC2[0xE8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BCF[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BE0[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BE3[0x2A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BE6[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C3C[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class AGeometryCollectionISMPoolActor*       ISMPoolActor;                                      // 0x30(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_C41[0x98];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C62[0xD6];                                     // Fixing Size Of Struct [ Dumper-7 ]
