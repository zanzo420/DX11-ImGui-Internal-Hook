...
public:
	...
	uint8                                        Pad_5AC9[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5ACC[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_Crafting_CraftInProgress           CallFunc_GetCurrentCraftData_ReturnValue;          // 0x20(0xD8)(HasGetValueTypeHash)
	uint8                                        Pad_5ACD[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_5ACF[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
