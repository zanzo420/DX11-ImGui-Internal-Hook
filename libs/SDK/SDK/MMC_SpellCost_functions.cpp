...
// BlueprintGeneratedClass MMC_SpellCost.MMC_SpellCost_C
// (None)

class UClass* UMMC_SpellCost_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MMC_SpellCost_C");

	return Clss;
}


// MMC_SpellCost_C MMC_SpellCost.Default__MMC_SpellCost_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMMC_SpellCost_C* UMMC_SpellCost_C::GetDefaultObj()
{
	static class UMMC_SpellCost_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMMC_SpellCost_C*>(UMMC_SpellCost_C::StaticClass()->DefaultObject);

	return Default;
}


// Function MMC_SpellCost.MMC_SpellCost_C.BaseCost
...
// double                             K2Node_MakeArray__2__ImplicitCast                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMMC_SpellCost_C::BaseCost(const struct FGameplayEffectSpec& Spec, double* Cost, class AEquippableItem* Temp_object_Variable, const struct FGameplayEffectContextHandle& CallFunc_GetEffectContext_ReturnValue, class AActor* CallFunc_EffectContextGetInstigatorActor_ReturnValue, TScriptInterface<class ILoadoutReadInterface> K2Node_DynamicCast_AsLoadout_Read_Interface, bool K2Node_DynamicCast_bSuccess, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute, float CallFunc_GetFloatAttribute_ReturnValue, class AEquippableItem* CallFunc_GetEquippedItem_ReturnValue, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute_1, float CallFunc_GetFloatAttribute_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, const struct FGameplayAttribute& Temp_struct_Variable, float CallFunc_CalculateItemAttributeValue_ReturnValue, TArray<double>& K2Node_MakeArray_Array, double CallFunc_StandardBonusFormulaInverted_Total, double K2Node_MakeArray__2__ImplicitCast, double K2Node_MakeArray__1__ImplicitCast, double K2Node_MakeArray__0__ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("MMC_SpellCost_C", "BaseCost");

	Params::UMMC_SpellCost_C_BaseCost_Params Parms{};
...
// Function MMC_SpellCost.MMC_SpellCost_C.NWXCalculateBaseMagnitude
...
float UMMC_SpellCost_C::NWXCalculateBaseMagnitude(struct FGameplayEffectSpec& Spec, struct FTagValueContainer& MMCIntermediateOutputs, double CallFunc_BaseCost_Cost, float K2Node_FunctionResult_ReturnValue_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("MMC_SpellCost_C", "NWXCalculateBaseMagnitude");

	Params::UMMC_SpellCost_C_NWXCalculateBaseMagnitude_Params Parms{};
