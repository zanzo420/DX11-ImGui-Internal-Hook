...
public:
	...
	uint8                                        Pad_436A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_436C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_436E[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4370[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4372[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
